...
- **Paul Klein IV** — **Re-checked 2026-09-04: cleared for addition.** [Natural's July 20, 2026 Series A announcement](https://www.natural.com/blog/natural-series-a) names Paul Klein IV individually as a participant in its AI-agent payments business. This supports individual participation under the same company-announcement standard used for other entries. It does not establish Hawk Hill's capital structure or claim that all his checks are personal; no scout or Hawk Hill portfolio checks are attributed to him here. The previous demand to prove that a vehicle has no outside LPs was too broad: the rules allow personally led syndicates and rolling funds.

- **Steven Tey** — **Re-checked 2026-09-04: cleared for addition.** [Polar's June 17, 2025 seed announcement](https://polar.sh/blog/polar-seed-announcement) names Tey among its angels and describes infrastructure for AI usage billing and agentic payments. This is independent primary evidence; the earlier source-license blocker no longer applies.
